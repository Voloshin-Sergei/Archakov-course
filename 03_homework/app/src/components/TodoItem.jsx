function TodoItem({ text, removeTask, id, editTask, color, checkedTask }) {
    ...
    <div className="todo-item" key={id}>
      <div className="todo-checkbox">
        <label htmlFor={`todo-${id}`}>
          <input type="checkbox" id={`todo-${id}`} onClick={checkClick} />
          <div>
      ...
      <div className="todo-actions">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 384" onClick={editClick}>
          <path d="M0 304v80h80l236-236-80-80zM378 56L328 6c-8-8-22-8-30 0l-39 39 80 80 39-39c8-8 8-22 0-30z"></path>
        </svg>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96" onClick={deleteClick}>
